...
public class TicTacToeBoard extends View {
    ...
    public void drawVerticalLine(Canvas canvas, int row, int col){
        canvas.drawLine(col * cellSize + (float)cellSize/2,row, col*cellSize + (float)cellSize/2,row*cellSize*3 , paint);
    }

    public void drawDiagonalLinePositive(Canvas canvas){
        canvas.drawLine(0,cellSize*3, cellSize*3,0, paint);
    }

    public void drawDiagonalLineNegative(Canvas canvas){
